...
###prediction
###export checkpoint_dir=/net/scratch_cms3a/ajung/deepjet/results/fgsm/checkpoint_epoch_12.pth
...
###export output_dir=/net/scratch_cms3a/ajung/deepjet/results/test/predict_fgsm_nominal_epoch_12
