...
apptainer exec --nv --bind=/hpcwork/rwth1244,$HOME,$WORK,$HPCWORK /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cernml4reco/deepjetcore3:latest /bin/bash $HOME/work/repositories/DeepJet/claix/setup_container.sh
