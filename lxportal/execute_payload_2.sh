...
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/2
export adv=_pgd2
python3 pytorch/train_DeepFlavour$adv.py $input_dir $output_dir


### prediction
export checkpoint_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/2/checkpoint_best_loss.pth
export traindata_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/2/trainsamples.djcdc
export sample_dir=one_sample_lxportal.txt
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/2/predict
python3 pytorch/predict_pytorch.py DeepJet_Run2 $checkpoint_dir $traindata_dir $sample_dir $output_dir

export checkpoint_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/2/checkpoint_best_loss.pth
export traindata_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/2/trainsamples.djcdc
export sample_dir=one_sample_lxportal.txt
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/2/predict_pgd_1
...
export traindata_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/2/trainsamples.djcdc
export sample_dir=one_sample_lxportal.txt
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/2/predict_pgd_2
