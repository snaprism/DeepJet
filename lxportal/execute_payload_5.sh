...
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5
export adv=_pgd5
python3 pytorch/train_DeepFlavour$adv.py $input_dir $output_dir


### prediction
export checkpoint_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/checkpoint_best_loss.pth
export traindata_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/trainsamples.djcdc
export sample_dir=one_sample_lxportal.txt
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/predict
python3 pytorch/predict_pytorch.py DeepJet_Run2 $checkpoint_dir $traindata_dir $sample_dir $output_dir

export checkpoint_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/checkpoint_best_loss.pth
export traindata_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/trainsamples.djcdc
export sample_dir=one_sample_lxportal.txt
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/predict_pgd_1
...
export traindata_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/trainsamples.djcdc
export sample_dir=one_sample_lxportal.txt
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/predict_pgd_2
...
export traindata_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/trainsamples.djcdc
export sample_dir=one_sample_lxportal.txt
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/predict_pgd_3
...
export traindata_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/trainsamples.djcdc
export sample_dir=one_sample_lxportal.txt
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/predict_pgd_4
python3 pytorch/predict_pytorch.py DeepJet_Run2 $checkpoint_dir $traindata_dir $sample_dir $output_dir -attack PGD -att_magnitude 0.01 -restrict_impact 0.2 -pgd_loops 4

export checkpoint_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/checkpoint_best_loss.pth
export traindata_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/trainsamples.djcdc
export sample_dir=one_sample_lxportal.txt
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/pgd_loops/5/predict_pgd_5
