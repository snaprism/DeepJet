...
export output_dir=/net/scratch_cms3a/ajung/deepjet/results/nominal/predict_pgd_100

python3 /home/home1/institut_3a/ajung/work/repositories/DeepJet/pytorch/predict_pytorch.py DeepJet_Run2 $checkpoint_dir $traindata_dir $sample_dir $output_dir -attack PGD -att_magnitude 0.05 -restrict_impact 0.2 -pgd_loops 100
